...
class FragmentDataset(Dataset):
    def __init__(self, vox_path, vox_type, dim_size=64, transform=None,selected_class=0):
        ...
        if selected_class!=0:
            self.vox_files=sorted(glob.glob(os.path.join(self.path,self.vox_type,f"{selected_class}","*.vox")))
        print('init')
